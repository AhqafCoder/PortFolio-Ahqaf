    ...
    return (
        <div className='bg-black text-white px-6 py-3 md:px-16 lg:px-24'>
            <div className='container flex justify-between items-center'>
                {/* Logo */}
                <div className='text-2xl font-bold'>Ahqaf Ali</div>
                ...
                {/* Desktop Button */}
                <button className='hidden md:inline bg-gradient-to-r from-purple-400 to-pink-500 text-black px-4 py-2 rounded-full transform transition-transform duration-300 hover:scale-105'>
                    Connect Me
                </button>
            ...
            {menuOpen && (
                <div className="md:hidden flex flex-col items-center space-y-4 py-4 bg-gray-900 rounded-lg">
                    ...
                    <button className='bg-gradient-to-r from-green-400 to-blue-500 text-black px-6 py-2 rounded-full'>
                        Connect Me
                    </button>
                </div>
            )}
